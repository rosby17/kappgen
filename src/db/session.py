...
def init_db():
    from src.db.models import User, Channel, Video, Folder, ApiKey, PasswordReset, Plan, Subscription, Order, ApiUsageLog, CreditPot, CreditTransaction, VoiceCloneJob, CommunityLibraryFolder, HuggingFaceAccount  # ensure models are imported
